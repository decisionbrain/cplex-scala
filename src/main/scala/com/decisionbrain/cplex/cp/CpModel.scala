...
import com.decisionbrain.cplex.{Addable, Constraint, IntExpr, IntSet, IntVar, Modeler, NumExpr, NumVar, Objective}
import com.decisionbrain.cplex.Modeler.{IntArray, IntExprArray, NumArray, NumExprArray}

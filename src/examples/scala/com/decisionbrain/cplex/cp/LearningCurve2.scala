...
/**
  ...
  * efficient is the production process. The learning curve depends on the current type, the previous type and the
  * machine.
  *
...
//    model.exportModel("learningcurve2.cpo")
  ...
  def solve(): Boolean = {
    ...
    model.cp.setParameter(IloCP.IntParam.FailLimit, 5000000)
